...
const paymentSchema = new mongoose.Schema({
    ...
    // For legacy credit-based payments
    userKey: {
        type: String,
        index: true
    },
    ...
    metadata: {
        ...
        userAgent: String,
        referer: String,
        userId: String, // Also store string version for easy logging
        planId: String,
    },
    completedAt: {
        type: Date
...
paymentSchema.statics.findActivePayment = function(userKey, creditAmount) {
    // This function is for the old credit system and can be kept or deprecated
    return this.findOne({
        userKey,
        creditAmount,
        status: 'pending',
...
paymentSchema.statics.findActiveSubscriptionPayment = function(userId, planId) {
    return this.findOne({
        userId,
        planId,
        status: 'pending',
